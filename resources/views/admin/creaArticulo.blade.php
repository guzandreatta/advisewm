...
<script>
  ...
  ga('send', 'pageview');
	...
	@endif
	<form id="newArticleES" role="nuevoArticulo" action="nuevoArticulo" method="POST" enctype="multipart/form-data">
		...
		<input type="hidden" name="languageselected" value="es">
		  ...
		  <div class="form-group">
			  <label for="article">{{ __('messages.article') }} (ES):</label>
			  <textarea class="form-control" id="summernoteESP" name="article">{{ old('article') }}
				</textarea>
		  </div>
		  <div class="form-group">
	...
	<form id="newArticleEN" role="nuevoArticulo" action="nuevoArticulo" method="POST" enctype="multipart/form-data">
		<input type="hidden" name="_token" value="{{ csrf_token() }}">
		<input type="hidden" name="languageselected" value="en">
		  ...
		  <div class="form-group">
			  <label for="article">{{ __('messages.article') }} (EN):</label>
			  <textarea class="form-control" id="summernoteENG" name="article">{{ old('article') }}
					</textarea>
		  </div>
		<div class="form-group">
